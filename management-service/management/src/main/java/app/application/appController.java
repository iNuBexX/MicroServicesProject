...
public class appController {
	...
	Long id =appRepo.findbyAppName(myRequest.getAppName()).get().getappId();
	this.appRepo.deleteById(id);	
	//if(this.appRepo.findbyAppName(myRequest.getAppName()).get()!=null)
	//System.out.println("delete failed of app"+myRequest.getAppName());
	//else
